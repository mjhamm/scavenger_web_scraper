...
session = boto3.Session('AKIAUQ5RSVGJ3UDNUQUO', 'WAyDoceRPktCU14J3RAN9A8f+NejU4zaMEF41dtC')
dynamo_client = session.resource('dynamodb', region_name='us-east-2')

recipe_table = dynamo_client.Table('recipes')
...
for page in allPages[:10]:
    ...
    for index in range(0, 1):
        ...
        if recipe.id == -1:
            ...
            try:
                recipe_table.put_item(Item=datadict)
